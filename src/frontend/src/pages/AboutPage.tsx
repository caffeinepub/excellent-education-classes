...
const VALUES = [
  {
    emoji: "🌟",
    title: "Excellence",
    desc: "We set high standards and inspire students to meet them.",
  },
  {
    emoji: "🤝",
    title: "Integrity",
    desc: "Honest, transparent, and always in the student's best interest.",
  },
  {
    emoji: "🌈",
    title: "Inclusivity",
    desc: "Every student — regardless of background — deserves quality education.",
  },
  {
    emoji: "🔥",
    title: "Passion",
    desc: "Our teachers are driven by a love of learning and teaching.",
  },
  {
    emoji: "🌱",
    title: "Growth",
    desc: "We celebrate every milestone, big or small, on the journey of learning.",
  },
  {
    emoji: "🎯",
    title: "Focus",
    desc: "Goal-oriented coaching that helps students prepare for what matters most.",
  },
];
      ...
      <section className="relative overflow-hidden holi-gradient-hero py-20 text-center">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <h1 className="font-display font-extrabold text-white text-4xl sm:text-5xl md:text-6xl mb-4 drop-shadow-md">
            About <span className="text-holi-yellow">Excellent</span>
            <br />
            Education Classes
          </h1>
          <p className="text-white/90 font-body text-lg max-w-xl mx-auto">
            A decade-long journey of transforming students into confident,
            capable achievers
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <div className="space-y-3 text-muted-foreground font-body leading-relaxed">
                <p>
                  Excellent Education Classes was born in 2010 from a simple but
                  powerful belief: every child deserves access to quality
                  education, regardless of their circumstances.
                </p>
                <p>
                  Founded by a small group of passionate educators, we started
                  with just two classrooms and ten students. Today, we proudly
                  serve over 500 students across Classes 1 to 12 and Graduation
                  level.
                </p>
                <p>
                  Our journey has been shaped by the trust of thousands of
                  families who chose us to guide their children's academic paths
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  gradient: "holi-gradient-card-orange",
                  text: "holi-text-orange",
                },
                {
                  num: "15+",
                  label: "Subjects Offered",
                  gradient: "holi-gradient-card-green",
                  text: "holi-text-green",
                },
                {
                  num: "95%",
                  label: "Pass Rate",
                ...
                >
                  <div
                    className={`font-display font-extrabold text-3xl ${text}`}
                  >
                    {num}
                  </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="bg-white rounded-2xl border border-border p-8 shadow-md relative overflow-hidden">
            ...
            <p className="text-foreground font-body text-lg leading-relaxed relative z-10 italic">
              "To empower every student with the knowledge, confidence, and
              skills they need to thrive academically and in life — delivered
              through personalized attention, expert teaching, and a joyful,
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 bg-holi-green/10 rounded-full px-4 py-2 mb-4">
              <span>✅</span>
              <span className="text-holi-green font-semibold text-sm">
                Why Choose Us
              </span>
            </div>
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-foreground mb-2">
              The <span className="holi-text-green">Excellent</span> Difference
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {WHY_CHOOSE.map(
              ({ icon: Icon, title, desc, gradient, textColor, iconBg }) => (
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-xl ${iconBg} flex items-center justify-center shrink-0 mt-0.5`}
                  >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {VALUES.map(({ emoji, title, desc }) => (
              ...
              >
                ...
                <p className="text-white/75 text-xs font-body leading-relaxed">
                  {desc}
                </p>
              </div>
            ))}
